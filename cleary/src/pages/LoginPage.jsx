...
const LoginPage = () => {
  ...
  return (
    <AnimatedBackground mood="neutral">
      ...
      <div className="fixed bottom-1/4 right-1/4 w-96 h-96 bg-pink-600/20 rounded-full blur-3xl pointer-events-none" />
        ...
        >
          ...
          <div className="relative backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 shadow-2xl">
            <motion.h1
              ...
              className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-purple-400 via-pink-400 to-purple-400 bg-clip-text text-transparent mb-2"
            >
              Welcome back
            </motion.h1>
            <motion.p
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            >
              <RippleButton
                type="submit"
                disabled={loading}
                className="relative w-full py-3 rounded-xl bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold hover:shadow-lg hover:shadow-purple-500/40 disabled:opacity-50 overflow-hidden group"
              >
          ...
          >
            ...
            <Link to="/signup" className="text-purple-300 hover:text-purple-200 underline font-semibold">
              Sign up
            </Link>
          </motion.p>
          </div>
