...
const SignupPage = () => {
  const { loginWithGoogle, loginAsGuest, isDemoMode, signup } = useAuth(); // Ensure signup is destructured
    ...
    try {
      if (name && email && password) {
        ...
        try {
          ...
          // Fallback to local if config error
          console.warn('Real signup failed, falling back to local:', authErr);
        }
